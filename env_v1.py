...
class Env:
    def __init__(self):
        ...
        self.client_quality = np.load('npydata/Q_loss_client50.npy')
        ...
        self.client_data_num = np.load('npydata/client_num_client50.npy')
        ...
        self.cluster_agg_idx_orgin = [self.cluster_q_idx[1][i] for i in self.cluster_agg_idx]
    ...
    def aggtime(self):
        ...
        a = np.array([len(self.cluster_agg_idx_orgin[i]) for i in range(5)])
    ...
    def init_obs(self):
        ...
        return s[0]
    def step(self,action,stepi,stepj,time):
        done = False
