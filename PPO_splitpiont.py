...
import pickle
with open(f'response_data/clientserverquit/return_0i_1.pkl','wb') as f:
    pickle.dump(return_list,f)
with open(f'response_data/clientserverquit/time_0i_1.pkl','wb') as f:
    pickle.dump(t_list,f)
with open(f'response_data/clientserverquit/error_0i_1.pkl', 'wb') as f:
